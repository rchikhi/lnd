...
// IsBorked returns true if the channel has entered a irreconcilable state
// caused by a breach or state desynchronization, and false otherwise.
func (lc *LightningChannel) IsBorked() bool {
	lc.RLock()
	defer lc.RUnlock()

	return lc.channelState.IsBorked
}
